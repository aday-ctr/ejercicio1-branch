...
[main f92d1f4] Solucionado conflicto bibliografía.
...
```code
git log --graph --all --oneline
* f92d1f4 (HEAD -> main) Solucionado conflicto bibliografía.
* 0910f9b Añadida nueva referencia bibliográfica.
* 2b09558 (origin/main, bibliografia) Añadida primera referencia bibliográfica.
* e34e1c0 Añadido capítulo 4.
* 2bbb386 Añadido el índice .
* 90c93c0 Se crea el indice.
* c7f96a3 Añadido capítulo 3.
