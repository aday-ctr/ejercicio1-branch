...
To https://github.com/aday-ctr/ejercicio1-branch
 * [new branch]      ejercicio2-branch -> ejercicio2-branch
pro@jpexposito-VirtualBox:~/Escritorio/git/ejercicio1-branch$ git checkout main
git merge ejercicio2-branch
error: Los cambios locales de los siguientes archivos serán sobrescritos por checkout:
        README.md
Por favor realice un commit con los cambios o un stash antes de cambiar ramas.
Abortando
Ya está actualizado.
pro@jpexposito-VirtualBox:~/Escritorio/git/ejercicio1-branch$ git push
fatal: La rama actual ejercicio2-branch no tiene una rama upstream.
Para realizar un push de la rama actual y configurar el remoto como upstream, use

        git push --set-upstream origin ejercicio2-branch

pro@jpexposito-VirtualBox:~/Escritorio/git/ejercicio1-branch$ git push --set-upstream origin ejercicio2-branch
Rama 'ejercicio2-branch' configurada para hacer seguimiento a la rama remota 'ejercicio2-branch' de 'origin'.
Everything up-to-date
pro@jpexposito-VirtualBox:~/Escritorio/git/ejercicio1-branch$     git checkout -b ejercicio3-branch
Cambiado a nueva rama 'ejercicio3-branch'
pro@jpexposito-VirtualBox:~/Escritorio/git/ejercicio1-branch$ 
pro@jpexposito-VirtualBox:~/Escritorio/git/ejercicio1-branch$ git branch
  ejercicio1-branch
  ejercicio2-branch
* ejercicio3-branch
  main
pro@jpexposito-VirtualBox:~/Escritorio/git/ejercicio1-branch$ git commit -m "Se incluye el Ejercicio3.java"
...
pro@jpexposito-VirtualBox:~/Escritorio/git/ejercicio1-branch$ git add ejercicio3.java
fatal: ruta especificada 'ejercicio3.java' no concordó con ningún archivo
pro@jpexposito-VirtualBox:~/Escritorio/git/ejercicio1-branch$ git add Ejercicio3.java
pro@jpexposito-VirtualBox:~/Escritorio/git/ejercicio1-branch$ git commit -m "Se incluye el Ejercicio3.java"
[ejercicio3-branch 48db9e6] Se incluye el Ejercicio3.java
 1 file changed, 5 insertions(+)
 create mode 100644 Ejercicio3.java
pro@jpexposito-VirtualBox:~/Escritorio/git/ejercicio1-branch$ git push origin ejercicio3-branch
